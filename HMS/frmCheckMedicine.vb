...
Public Class frmCheckMedicine
    ...
    Private Sub frmCheckMedicine_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frmCheckMedicine_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        conn.Close()
        conn.Dispose()
